...
print('for demonstration purpose, download small number of data only.')
print('I will eventually use a larger data set that was downloaded beforehand using this code')
n_random = 30
j = 0
...
df = df_temp.reset_index('idDrink', drop=True)
...
print('Now loading a larger data set from my local computer that was downloaded beforehand...')
df=pd.read_pickle('cocktails.pkl')
